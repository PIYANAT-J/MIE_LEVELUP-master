var base_path = '/MIE_LEVELUP-master';
var uploader = new plupload.Uploader({
    runtimes : 'html5,flash,silverlight,html4',
        ...
        url : base_path + '/pubilc/section/picture_game', // กำหนด path เพื่อส่งไปทำการอัพโหลดรูปภาพ
...
var display = function(){
    ...
    $.ajax({url : base_path + '/pubilc/section/picture_game',
