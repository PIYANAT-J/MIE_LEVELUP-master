...
<section class="site-section" id="game-section">
    <div class="container">
        ...
        <div id="posts" class="row no-gutter">
            ...
            <div class="item news col col-lg-3 mb-4 mb-lg-2" data-aos="fade-up" data-aos-delay="300">
                <div class="h-entry">
                    <a href="single.html">
                        <img src="dist/images/post_1.jpg" alt="Image" class="img-fluid">
                    </a>
            ...
            <div class="item hot col col-lg-3 mb-4 mb-lg-2">
                <div class="h-entry">
                    <a href="single.html">
                        <img src="section/picture_game/csgo.jpg" alt="Image" class="img-fluid">
                    </a>
                    <h2 class="font-size-regular"><a href="#">Repudiandae Quisquam Eaque Dolore</a></h2>
            ...
            <div class="item news col col-lg-3 mb-4 mb-lg-2">
                <div class="h-entry">
                    <a href="single.html">
                        <img src="dist/images/post_1.jpg" alt="Image" class="img-fluid">
                    </a>
        ...
        <div class="row">
            <div class="col-12 text-right" data-aos="fade">
                <p><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="#">Continue Reading...<i class="icon-facebook mr-2"></i></a></p>
                <p><i class="fa fa-address-book"></i> &#8282;<a href="#">Continue Reading...<i class="icon-home"></i></a></p>
            </div>
        </div>
    </div>
</section>
...
<section class="site-section border-bottom bg-light" id="team-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 mb-5" data-aos="fade-up" data-aos-delay="">
