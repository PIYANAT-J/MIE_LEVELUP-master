...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('dist/css/navbar2.css') }}">
                    ...
                    <div class="col-lg-7 col-xl-8  d-none d-lg-block d-xl-block">
                        <nav class="site-navigation position-relative" role="navigation">
                            <ul class="site-menu main-menu js-clone-nav d-none d-lg-block" style="margin-top:30px;"> 
                                ...
                                @guest
                                    <li><a href="{{ route('login-levelUp') }}" class="nav-link active  mr-4 my-2" style="padding:0px;margin:5px 0 5px 0;"><h1 class="fontNavbar">การติดตามของฉัน</h1></a></li>
                                @else
                                    <li><a href="{{ route('FollowMe') }}" class="nav-link active mr-4 my-2" style="padding:0px;margin:5px 0 5px 0;"><h1 class="fontNavbar">การติดตามของฉัน</h1></a></li>
                                @endguest
