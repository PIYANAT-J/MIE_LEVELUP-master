                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-10 d-none d-xl-block font_navbar home">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block"> 
                                <li><a href="{{ url('/') }}" class="nav-link active pt-3" style="font-family:myfont; padding:0px 10px 0px 10px; ">หน้าแรก</a></li>
                                <li><a href="#game-section" class="nav-link" style="font-family:myfont; padding:0px 10px 0px 10px;">หมวดหมู่</a></li>
                                <li><a href="#myfollow" class="nav-link" style="font-family:myfont; padding:0px 10px 0px 10px;">การติดตามของฉัน</a></li>
                                <li style="width:400px">
                                <input style="font-family:myfont1; margin-top:50px;" class="search_btn " type="text" placeholder="ค้นหา" aria-label="Search">
                                </li>
                                @guest
                                    <img style="padding:0px 0px 0px 20px;" src="{{asset('/icon/sign_in.svg') }}">
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="dropdown">
                                        <li class="nav-item">
                                            ...
                                            @else
                                                <a class="nav-link" href="{{ route('Admin') }}">{{ __('โปรไฟล์') }}</a>
                                            @endif
                                        </li>
                                        <li class="nav-item">
                                            <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
