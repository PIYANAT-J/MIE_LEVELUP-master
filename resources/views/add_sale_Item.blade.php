                        ...
                        <div class="col-lg-9" style="background-color:#141621; ">
                            <div class="row mt-4 px-4" >
                                <div class="col-12 " style="color:#fff;">
                                    ...
                                    <a class="avatar-link" style="margin: 0 8px;"> > </a>
                                    <a href="/sale" class="avatar-link active">ขายไอเทม</a>
                                    <a class="avatar-link" style="margin: 0 8px;"> > </a>
                                    <a href="/add_sale_item" class="avatar-link">เพิ่มไอเทมขาย</a>
                                </div>
                            </div>
                            ...
                            <div class="row mx-2 mb-4 mt-2">
                                        ...
                                        <div class="col-lg-12">
                                            <ul class="nav">
                                                ...
                                                <li class="nav-item mx-2">
                                                    <a class="nav-link itemAvatar3" data-toggle="tab" href="#clothes2">เสื้อผ้่า</a>
                                                </li>
                                                <li class="nav-item">
                                ...
                                <div class="col-lg-6" style="background-color:#202433;border-radius: 6px;">
                                    ...
                                    <div class="row mx-0" >
                                        ...
                                        <div class="col-3 my-3 text-center" style="padding:0;">
