    ...
    <div class="row  mt-3">
        ...
        <div class="col-lg-3" style="background-color: #17202c;">
            <div class="row">
                ...
                <a href="{{ route('DevKyc') }}" style="width: 100%;"><button class="btn-sidebar active"><span style="font-family: myfont1;font-size: 1em;padding:0px 10px 0px 5px;">KYC</span>ยืนยันตัวตน
                                                ...
                                                <div class="col-lg-6 mt-2" >
                                                    <label class="bgInput field-wrap">
                                                        <label class="fontHeadInput px-3 py-2" style="padding:0;">เลขบัตรประจำตัวประชาชน</label> <br>
                                                            <input name="DEV_ID_CARD" class="input-login px-3" minlength="13" maxlength="13" value="{{ $DEV->DEV_ID_CARD }}" disabled></input>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="row mt-2 ">
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12 mt-2">
                                                        <button name="submit" value="submit" type="submit" class="btn-submit">ยืนยัน
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-lg-6 mt-2" >
                                                <label class="bgInput field-wrap">
                                                        <label class="fontHeadInput px-3 py-2" style="padding:0;">เลขบัตรประจำตัวประชาชน</label> <br>
                                                        <input name="DEV_ID_CARD" class="input-login px-3" minlength="13" maxlength="13" disabled></input>
                                                </label>
                                            </div>
                                            <div class="col-lg-6"></div>
                                        </div>
