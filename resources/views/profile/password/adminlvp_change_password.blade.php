        ...
        <!-- sidebar -->
            <div class="row">
                <div class="col-lg-1"></div>
                    ...
                    <a href="/admin_change_password" style="width: 100%;"><button class="btn-sidebar active"><i class="icon-change-pass" style="font-size:1.1em;padding:0px 15px 0px 13px;"></i>เปลี่ยนรหัสผ่าน</button></a>
