<div class="col-lg-4 col-xl-3 d-none d-lg-block d-xl-block" style="background-color: #17202c;" id="navActive">
    <div class="row">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-8">
                            <label class="pt-3">
                                ...
                                <h5 style="margin:0;color:#ffffff;">สถานะ : ผู้พัฒนาระบบ</h5>
        ...
        <a href="{{ route('DevProfile') }}" style="width: 100%;">
            <button class="btn-sidebar">
                <p style="margin: 0;"><i class="icon-profile menuIcon"></i>ข้อมูลส่วนตัว</p>
            </button>
        </a>
        <a href="{{ route('DevKyc') }}" style="width: 100%;">
            <button class="btn-sidebar">
        ...
        <a href="{{ route('DevShelf') }}" style="width: 100%;">
            <button class="btn-sidebar">
                <p style="margin: 0;"><i class="icon-game-shelf menuIcon"></i>ตู้เกม (เกมเชล)</p>
            </button>
        </a>
        <a href="{{ route('DevHistory') }}" style="width: 100%;">
            <button class="btn-sidebar">
                <p style="margin: 0;"><i class="icon-history menuIcon"></i>ประวัติพอยท์</p>
            </button>
        </a>
        <a href="{{ route('DevUpload') }}" style="width: 100%;">
            <button class="btn-sidebar">
                <p style="margin: 0;"><i class="icon-upload-game menuIcon"></i>อัพโหลดเกม</p>
            </button>
        </a>
        <a href="{{ route('DevWithdraw') }}" style="width: 100%;">
            <button class="btn-sidebar">
                <p style="margin: 0;"><i class="icon-withdraw menuIcon"></i>ถอนเงิน</p>
            </button>
        </a>
        <a href="/develper_change_password" style="width: 100%;">
            <button class="btn-sidebar">
