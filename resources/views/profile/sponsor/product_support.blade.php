                    ...
                    <div class="row mt-3">
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            ...
                            <label class="bgInput field-wrap my-1">
                                ...
                                <label style="padding:0;"><SELECT class="MySelectProductSupport p pl-2" size="1" id ="year" name = "yyyy" onchange="change_year(this)"></SELECT></label>
                                <label style="padding:0;"><SELECT class="MySelectProductSupport p pl-2" size="1"  id ="month" name = "mm" onchange="change_month(this)"></SELECT></label>
                                <label style="padding:0;"><SELECT class="MySelectProductSupport p pl-2" size="1" id ="day" name = "dd"></SELECT></label>
                            </label>
                ...
                <div class="row" >
                    <div class="col-12" >
                        <div class="row">
                            ...
                            <p class="success-status mt-2" style="text-align:center;margin:0;">
                                @if(Session::has('product'))
                                    {{ Session::get('product') }}
                                @else
                                    {{ Session::get('deadline') }}
