                            ...
                            <div class="row mx2">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6 text-right p">฿ {{number_format($allPackage->package_amount, 2)}}</div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6 text-right"><h4 style="margin:0;color:#ce0005;font-weight:800;">฿ {{number_format($allPackage->package_amount, 2)}}</h4></div>
                                    </div>
                                </div>
                            </div>
