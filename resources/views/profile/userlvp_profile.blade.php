    ...
    <div class="row  mt-3">
        ...
        <div class="col-lg-3" style="background-color: #17202c;">
            <div class="row">
                ...
                <div class="col-lg-1"></div>
                <a href="/user_lvp" style="width: 100%;"><button class="btn-sidebar active"><i class="icon-profile" style="font-size:0.85em;padding:0px 17px 0px 10px;"></i>ข้อมูลส่วนตัว</button></a>
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-12 line1 mt-2" >
                                    <input class="input-update"  placeholder="ชื่อ" require></input>
                                    <input class="input-update"  placeholder="นามสกุล" require></input>
                                    <input class="input-update"  placeholder="เบอร์โทร" data-toggle="tooltip" data-placement="bottom" title="ตัวอย่าง:082 222 2222" maxlength="10"></input>
