                            ...
                            <div class="row">
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5 ml-3 mr-3">
                                            <div class="mt-3">
                                                <input id="SPON_BIRTHDAY" name="SPON_BIRTHDAY" type="text" class="form-control textbox1 " placeholder="YYYY-MM-DD" value="{{ $SPON->SPON_BIRTHDAY }}" title="">
                                            </div>
                                        </div>
                                        <div class="col "></div>
                                        <div class="w-100"></div>
                    ...
                    <div class="row">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-5 ml-3 mr-3">
                                    <div class="mt-3">
                                        <input id="SPON_BIRTHDAY" name="SPON_BIRTHDAY" type="text" class="form-control textbox1 " placeholder="YYYY-MM-DD" value="{{ old('SPON_BIRTHDAY') }}" title="">
                                    </div>
                                </div>
                                <div class="col "></div>
                                <div class="w-100"></div>
                                ...
                                <div class="col-sm-5 ml-3 mr-3">
                                    <div class="mt-3">
                                        <select class="custom-select textbox1" id="inputGroupSelect01" name="SPON_GENDER" value="{{ old('SPON_GENDER') }}" required>
                                            <option name="SPON_GENDER" value="Select" selected>เลือก</option>
                                            <option name="SPON_GENDER" value="Men">ชาย</option>
                                            <option name="SPON_GENDER" value="Women">หญิง</option>
                                        </select>
                                    </div>
