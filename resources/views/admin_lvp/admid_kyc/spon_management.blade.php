    ...
    <div class="row">
                ...
                <div class="col-lg-1"></div>
                    ...
                    <button class="btn-sidebar active"  data-toggle="collapse" data-target="#demo"><span style="font-family: myfont1;font-size: 20px;padding:0px 11px 0px 5px;">KYC</span>จัดการการยืนยันตัวตน</button>
                        <div id="demo" class="collapse">
                            ...
                            <a href="/sponsor_management" style="width: 100%;"><button class="btn-sidebar active" style="padding-left:3.5em;">• &nbsp; &nbsp; ผู้สนับสนุน</button></a>
                        </div> 
        ...
        <div class="col-lg-9" style="background-color: #f5f5f5;">
            ...
            <div class="row pb-2 pt-3">
                <div class="col-10" style="font-family:myfont;color:#000;font-size:1.4em;">ข้อมูลผู้สนับสนุน</div>
                <div class="col-2 text-right">
                    <select class="select3">
                        <option class="option-select-rate">ประเภทผู้สนับสนุน</option>
                        <option class="option-select-rate">บุคคลธรรมดา</option>
                        <option class="option-select-rate">นิติบุคคล</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="nav topnav2">
                        ...
                        <li><a class="nav-link" data-toggle="tab" href="#spon3">ไม่ผ่านการอนุมัติ</a></li>
                                        ...
                                        <div class="row row4"> 
                                           <div class="col-lg-12">
                                                <div class="row item">
                                                    ...
                                                    <div class="col-2 py-1 td1 text-left">ชื่อ-นามสกุล</div>
                                                    <div class="col-2 py-1 td1 text-left">spon1@email.com</div>
                                                ...
                                                <div class="row item">
                                                    ...
                                                    <div class="col-2 py-1 td1 text-left">ชื่อ-นามสกุล</div>
                                                    <div class="col-2 py-1 td1 text-left">spon2@email.com</div>
                                                    <div class="col-2 py-1 td1">นิติบุคคล</div>
                                                    <div class="col-2 py-1 td1">
                                                        <!-- <label class="status-wait-approve" data-toggle="modal" data-target="#pendingApprove">รอการตรวจสอบ</label> -->
                                                        <label class="status-approve" data-toggle="modal" data-target="#Approve">อนุมัติแล้ว</label>
                                                        <!-- <label class="status-none-approve" data-toggle="modal" data-target="#noneApprove1">ไม่ผ่านการอนุมัติ</label> -->
                                                ...
                                                <div class="row item">
                                                    ...
                                                    <div class="col-2 py-1 td1 text-left">ชื่อ-นามสกุล</div>
                                                    <div class="col-2 py-1 td1 text-left">spon3@email.com</div>
                                                    <div class="col-2 py-1 td1">บุคคลธรรมดา</div>
                                                    <div class="col-2 py-1 td1">
                                                        <!-- <label class="status-wait-approve" data-toggle="modal" data-target="#pendingApprove">รอการตรวจสอบ</label> -->
                                                        <!-- <label class="status-approve" data-toggle="modal" data-target="#Approve">อนุมัติแล้ว</label> -->
                                        ...
                                        <div class="row row4"> 
                                           <div class="col-lg-12">
                                                <div class="row item">
                                                    ...
                                                    <div class="col-1 py-1 td1">admin03</div>
                                                    <div class="col-2 py-1 td1">23/06/63</div>
                                                </div>
                                                <div class="row item">
                                                    <div class="col-1 py-1 td1">2</div>
