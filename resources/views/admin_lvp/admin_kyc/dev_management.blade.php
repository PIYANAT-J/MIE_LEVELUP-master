...
<div class="container-fluid">
    <div class="row" id="getActive" active="/develop_management">
        ...
        <div class="col-10" style="background-color: #f5f5f5;">
            ...
            <div class="row pb-2 pt-3">
                <div class="col-12"><h1 class="fontHeader">ข้อมูลการยืนยันตัวตนผู้พัฒนาระบบ<h1></div>
            </div>
                ...
                <div class="row px-3">
                    <div class="col-6 pb-1">
                        <label class="bgInput field-wrap my-1">
                            ...
                            <input type="text" class="input1 p ml-2" value="{{$KycModel->KYC_ID_CARD}}" disabled>
                        </label>
                        <label class="bgInput field-wrap my-1">
                            <p class="fontHeadInput">ชื่อ</p>
                            <input type="text" class="input1 p ml-2" value="{{$KycModel->name}}" disabled>
                        </label>
                        <label class="bgInput field-wrap my-1">
                            <p class="fontHeadInput">นามสกุล</p>
                            <input type="text" class="input1 p ml-2" value="{{$KycModel->surname}}" disabled>
                        </label>
                        <label class="bgInput field-wrap my-1">
                            <p class="fontHeadInput">อีเมล</p>
                            <input type="text" class="input1 p ml-2" value="{{$KycModel->email}}" disabled>
                        </label>
                    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row px-3">
                    <div class="col-6 pb-1">
                        <div class="row"><label class="status-approve p" style="text-align:center;">อนุมัติแล้ว</label></div>
                        <label class="bgInput field-wrap my-1">
                            <p class="fontHeadInput">บัตรประจำตัวประชาชน</p>
                            <input type="text" class="input1 p ml-2" value="{{$KycModel->KYC_ID_CARD}}" disabled>
                        </label>
