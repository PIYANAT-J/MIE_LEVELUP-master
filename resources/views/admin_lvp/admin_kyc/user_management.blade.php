                ...
                <div class="col-lg-1"></div>
                    ...
                    <button class="btn-sidebar active"  data-toggle="collapse" data-target="#demo"><span style="font-family: myfont1;font-size: 1em;padding:0px 10px 0px 5px;">KYC</span>จัดการการยืนยันตัวตน</button>
                        <div id="demo" class="collapse">
                            <a href="/user_management" style="width: 100%;"><button class="btn-sidebar active" style="padding-left:3.5em;">• &nbsp; &nbsp; ผู้ใช้ทั่วไป</button></a>
        ...
        <!-- sidebar -->
            ...
            <div class="col-lg-9" style="background-color: #f5f5f5;">
                ...
                <div class="row pb-2 pt-3">
                    <div class="col-lg-9" style="font-family:myfont;color:#000;font-size:1.2em;">ข้อมูลสมาชิกผู้ใช้ทั่วไป</div>
                </div>
