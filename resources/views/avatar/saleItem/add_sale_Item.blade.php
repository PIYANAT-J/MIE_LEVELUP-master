                            ...
                            <div class="row" >
                                ...
                                <div class="col-5 ">
                                    <label class="labelInputAvatar my-4">
                                        ...
                                        <input type="number" name="dataprice" value="{{old('dataprice')}}" class="input-avatar h6" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="ตั้งราคาไอเทม">
                                    </label>
                                </div>
